...
function Contacto() {
  ...
  return (
    <section id="contacto" className="section-dark">
      ...
      <p className="section-subtitle">¿Tienes un proyecto o propuesta? Escríbeme</p>
      ...
      <div className="contact-container">
        ...
        <div className="contact-socials">
          <a
            href="https://github.com/rodrigopsimoes"
            target="_blank"
      ...
      <footer className="footer" style={{ marginTop: "4rem" }}>
        <p>© 2025 Rodrigo P. Simões — Network & DevOps Engineer</p>
        <p style={{ marginTop: "0.25rem" }}>Construido con React + Vite + TailwindCSS ❤️</p>
      </footer>
    </section>
  );
}
